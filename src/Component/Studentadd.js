        ...
        <div className="k">
            <form action="" onSubmit={handleSubmit} className="k">
                <div className="field1">
                    ...
                    <label>Age:</label>
                    <input type="number" id="age" name="age" value={details.age} onChange={handleChange}/>
                    </div>
                    <br />
                    <div className="field3">
                    <label>Course:</label>
                    <input type="text" id="course" name="course" value={details.course} onChange={handleChange} />
                    </div>
                    <br />
                    <div className="field4">
                    <label>Department:</label>
                    <input type="text" id="batch" name="batch" value={details.batch} onChange={handleChange}/>
                    </div>
                    <br />
                <Link to="/student">
